export default {
  ...
  knowledgeBase: {
    ...
    importPreprocessedChunks: "导入预处理 chunks",
    preprocessedImportTitle: "导入预处理 chunks",
    preprocessedImportDesc: "选择预处理工具生成的 JSONL 文件。系统会保留 chunk 边界和 metadata，并直接写入检索索引。",
    preprocessedDocumentsFile: "documents.jsonl",
    preprocessedDocumentsTip: "可选；包含文档标题、来源文件、doc_type、product 等文档级信息。",
    preprocessedChunksFile: "chunks.jsonl",
    preprocessedChunksTip: "必选；包含 chunk_id、doc_id、content、heading_path、keywords 等分块数据。",
    preprocessedSelectFile: "选择文件",
    preprocessedReplaceFile: "替换文件",
    preprocessedFileTypeHint: "请选择 .jsonl 或 .json 文件",
    preprocessedChunksRequired: "请先选择 chunks.jsonl",
    preprocessedChunksEmpty: "chunks 文件中没有可导入的数据",
    preprocessedNoImportableDocs: "没有找到可导入的文档",
    preprocessedParseError: "{file} 第 {line} 行解析失败：{message}",
    preprocessedImporting: "导入中",
    preprocessedImportProgress: "正在导入 {current}/{total} 个文档",
    preprocessedImportSuccess: "已导入 {docs} 个文档，{chunks} 个 chunks",
    preprocessedImportFailed: "预处理 chunks 导入失败",
    typeURL: "网页",
    typeManual: "手动创建",
    typeFile: "文件",
    channelLabel: "来源渠道",
