export default {
  ...
  knowledgeBase: {
    ...
    importPreprocessedChunks: 'Import preprocessed chunks',
    preprocessedImportTitle: 'Import preprocessed chunks',
    preprocessedImportDesc: 'Select JSONL files generated by your preprocessing pipeline. Chunk boundaries and metadata will be preserved and indexed directly.',
    preprocessedDocumentsFile: 'documents.jsonl',
    preprocessedDocumentsTip: 'Optional. Provides document-level title, source file, doc_type, product, and related metadata.',
    preprocessedChunksFile: 'chunks.jsonl',
    preprocessedChunksTip: 'Required. Provides chunk_id, doc_id, content, heading_path, keywords, and chunk metadata.',
    preprocessedSelectFile: 'Select file',
    preprocessedReplaceFile: 'Replace file',
    preprocessedFileTypeHint: 'Please select a .jsonl or .json file',
    preprocessedChunksRequired: 'Please select chunks.jsonl first',
    preprocessedChunksEmpty: 'No importable chunks found in the chunks file',
    preprocessedNoImportableDocs: 'No importable documents found',
    preprocessedParseError: 'Failed to parse {file} line {line}: {message}',
    preprocessedImporting: 'Importing',
    preprocessedImportProgress: 'Importing {current}/{total} documents',
    preprocessedImportSuccess: 'Imported {docs} documents and {chunks} chunks',
    preprocessedImportFailed: 'Failed to import preprocessed chunks',
    typeURL: 'URL',
    typeManual: 'Manual',
    typeFile: 'File',
    ...
    sourceManual: 'Manual',
    sourcePreprocessed: 'Preprocessed import',
